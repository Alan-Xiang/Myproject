...
_RE_EMAIL= re.compile(r'^[a-zA-Z0-9]+.[a-zA-Z]+@hp.com$')
...
#use cookie  to track user's status.
def user2cookie(user, max_age):
	'''
	Generate cookie str by users
	'''
...
@get('/manage/blogs')
def manage_blogs(request, *, page='1', t=None):
    return {
...
@post('/api/users')
async def api_register_user(request, *, name, email, passwd):
