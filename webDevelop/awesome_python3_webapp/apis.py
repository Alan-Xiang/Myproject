...
class Page(object):
	...
	def __init__(self, item_count, page_index=1, page_size=10):
		...
		if (item_count//page_size==0) or (page_index>self.page_count):
			self.offset= 0
			self.limit= item_count%page_size
			self.page_index= 1
		else:
...
class APIPermissionError(APIError):
	...
	def __init__(self,message=''):
		super(APIValueError,self).__init__('permission:forbidden','permission',message)
